...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#0A192F]/95 backdrop-blur-xl border-t border-[#00EFB5]/10">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
                        ...
                        <div className="flex gap-4">
                            {socialLinks.map(({ name, icon: Icon, url }) => (
                                <a
                                    ...
                                    href={url}
                                    aria-label={name}
                                    className="w-10 h-10 rounded-lg border border-[#00EFB5]/20 flex items-center justify-center text-gray-300 hover:border-[#00EFB5] hover:text-[#00EFB5] hover:bg-[#00EFB5]/10 transition-all"
                                >
                                    <Icon size={18} />
                                </a>
                            ))}
                        ...
                        <ul className="space-y-3">
                            {footerLinks.company.map(link => (
                                <li key={link.label}>
                                    <a
                                        href={link.path}
                                        className="text-sm font-medium tracking-wide text-gray-300 hover:text-[#00EFB5] transition-colors"
                                    >
                                        {link.label}
                                    </a>
                                </li>
                ...
                {/* Bottom */}
                <div className="pt-8 border-t border-[#00EFB5]/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                        ...
                        <Zap size={16} className="text-[#00EFB5]" />
