    ...
    return (
        <section className={`relative pt-32 pb-20 px-6 transition-opacity duration-1000 ${isHydrated ? 'opacity-100' : 'opacity-0'}`}>
            <div className="max-w-7xl mx-auto text-center">
                <div className="inline-block mb-4 px-4 py-1.5 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-400 text-sm font-medium tracking-wide animate-fade-in-up">
                    Available for new projects
                </div>
                <h1 className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-purple-200 to-purple-400 mb-8 tracking-tight">
                    Let's Build <br className="hidden md:block" />
                    Something <span className="text-purple-500">Impossible</span>
                </h1>
